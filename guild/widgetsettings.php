...
class WidgetSettings{
    ...
    public function get_guild_widget_settings(string $guild_id){
    ...
    public function modify_guild_widget_settings(string $guild_id, bool $enabled, string $channel_id,
